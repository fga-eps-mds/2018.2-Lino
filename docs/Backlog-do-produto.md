...
|FT05|Envio de mensagens à comunidade acadêmica| EP01|
...
|US02|T04|Enviar através de mensagens do cardápio semanal  para o usuário cadastrado no *Telegram* | FT01| 5 |
|US04|T01| Determinar ação para que o usuário possa retirar ou adicionar permissão de notificação(diário e semanal) no *Messenger*| FT01 & FT04| 5 |
|US04|T02|Determinar ação para que o usuário possa retirar ou adicionar permissão de notificação(diário e semanal) no *Telegramr*| FT01 & FT04| 5 |
|US04|T03|Alterar permissões do usuário do *Messenger*, no banco de dados, de acordo com o recebido pelo Lino | FT01 & FT04| 13 |
|US04|T04|Alterar permissões do usuário do *Telegram*, no banco de dados, de acordo com o recebido pelo Lino | FT01 & FT04| 13 |
